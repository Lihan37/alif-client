  ...
  return (
    <div className="relative overflow-hidden">
      <section className="animate-hero-in relative isolate">
        ...
        <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-4 pb-16 pt-8 font-bn sm:px-6 md:grid-cols-[1.1fr_0.9fr] md:gap-12 md:pb-20 md:pt-10">
          <div className="relative z-10">
            <p className="mb-6 text-base font-semibold uppercase tracking-[0.06em] text-text-muted md:text-lg">
              আলিফ রেস্টুরেন্ট · Alongkar
            </p>
            ...
            <p className="mt-6 max-w-xl text-base text-text-secondary md:text-xl">
              <span className="block">
                ঠিকানা: Alongkar, Alongkar Shopping Complex, Port Connecting Rd, Chattogram 4202
              </span>
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 md:mt-10">
              ...
              <Link
                to="/alongkar-branch/contact"
                className="inline-flex items-center gap-2 rounded-full border border-brand-dark/20 bg-white px-6 py-3 text-sm font-semibold text-text-primary shadow-[0_12px_24px_-14px_rgba(0,0,0,0.18)] transition duration-300 ease-out hover:-translate-y-0.5 hover:border-accent hover:text-accent active:scale-[0.98] md:px-7 md:py-3.5 md:text-base"
              >
                যোগাযোগ দেখুন
              </Link>
            </div>
          ...
          <div className="relative z-10">
            <div className="w-full rounded-[28px] border border-brand-dark/30 bg-white p-5 shadow-[0_30px_90px_-60px_rgba(0,0,0,0.35)] sm:rounded-[32px] sm:p-8">
              <p className="text-sm font-semibold uppercase tracking-[0.05em] text-text-muted md:text-base">
                আরেক শাখা
              </p>
