...
const NAV_LOGO_URL =
  'https://res.cloudinary.com/duaysox2a/image/upload/v1773223448/Gemini_Generated_Image_wexpbawexpbawexp-removebg-preview_iyzysj.png';
    ...
    <div className="flex min-h-screen flex-col bg-surface-main text-text-primary">
      <header className="sticky top-0 z-50 border-b border-brand-dark/20 bg-surface-main/90 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
          <Link to="/alongkar-branch" className="flex items-center gap-3" onClick={closeMobileMenu}>
            <img src={NAV_LOGO_URL} alt="Alongkar logo" className="h-12 w-auto origin-left scale-[2]" />
          </Link>

          <nav className="hidden items-center gap-8 text-base font-sans font-semibold tracking-normal text-text-secondary md:flex">
            <NavLink className={navClassName} to="/alongkar-branch/menu">
              Menu
            </NavLink>
            <NavLink className={navClassName} to="/alongkar-branch/about">
              About
            </NavLink>
            <NavLink className={navClassName} to="/alongkar-branch/events">
              Events
            </NavLink>
            <NavLink className={navClassName} to="/alongkar-branch/contact">
              Contact
            </NavLink>
            <NavLink className={navClassName} to="/alongkar-branch/our-people">
              Our People
            </NavLink>
          </nav>
          ...
          <div className="fixed inset-0 z-100 bg-black/35 px-5 py-6 md:hidden" onClick={closeMobileMenu}>
            ...
            >
              ...
              <nav className="flex flex-col items-center gap-3 pb-2">
                <NavLink className={mobileNavClassName} to="/alongkar-branch/menu" onClick={closeMobileMenu}>
                  Menu
                </NavLink>
                <NavLink className={mobileNavClassName} to="/alongkar-branch/about" onClick={closeMobileMenu}>
                  About
                </NavLink>
                <NavLink className={mobileNavClassName} to="/alongkar-branch/events" onClick={closeMobileMenu}>
                  Events
                </NavLink>
                <NavLink className={mobileNavClassName} to="/alongkar-branch/contact" onClick={closeMobileMenu}>
                  Contact
                </NavLink>
                <NavLink
                  className={mobileNavClassName}
                  to="/alongkar-branch/our-people"
                  onClick={closeMobileMenu}
                >
                  Our People
                </NavLink>
